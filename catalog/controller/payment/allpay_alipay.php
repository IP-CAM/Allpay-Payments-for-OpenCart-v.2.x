...
class ControllerPaymentAllpayAlipay extends Controller {

    private $paymentSubfix = 'alipay';
    ...
    public function index() {
        ...
        $szFirstName =  ($this->customer->getFirstName() ? $this->customer->getFirstName() : $_SESSION[$_SESSION['account']]['firstname'] );
        $szLastName = ($this->customer->getLastName() ? $this->customer->getLastName() : $_SESSION[$_SESSION['account']]['lastname']);
        $szUsername = (strpos($this->language->get('code'), 'zh') !== true ? "$szLastName $szFirstName" : "$szFirstName $szLastName");
        $szEmail = ($this->customer->getEmail() ? $this->customer->getEmail() : $_SESSION[$_SESSION['account']]['email']);
        $szPhone = ($this->customer->getTelephone() ? $this->customer->getTelephone() :$_SESSION[$_SESSION['account']]['telephone']);
        
        $oPayment->SendExtend['Email'] = $szEmail;
        $oPayment->SendExtend['PhoneNo'] =  $szPhone;
        $oPayment->SendExtend['UserName'] = $szUsername;
